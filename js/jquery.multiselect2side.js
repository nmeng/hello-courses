			...
			return this.each(function () {
				...
				if (o.search != false && o.optGroupSearch != false) {
					var ss = 
						...
						o.search + "<div align='CENTER'><input class='small' type='text' value='Search' /></div>";
					...
					var	ss = o.search + "<div align='CENTER'><input type='text' value='Search' /></div>";
				...
				var htmlToAdd = 
					"<div class='ms2side__div'>" +
											((o.labelsx || leftSearch != false) ? ("<div class='ms2side__header'>" + (leftSearch != false ? leftSearch : o.labelsx) + "</div><br>") : "") +
						...
						"</div>" +
						"<div class='ms2side__select' align='left'>" +
